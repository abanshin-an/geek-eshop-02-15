...
--     price_date  timestamp without time zone NOT NULL DEFAULT LOCALTIMESTAMP,
...
(
    ...
    store_id      bigint                      NOT NULL REFERENCES store (id) ON DELETE NO ACTION ON UPDATE NO ACTION,
    purchase_date timestamp without time zone NOT NULL DEFAULT LOCALTIMESTAMP
);
